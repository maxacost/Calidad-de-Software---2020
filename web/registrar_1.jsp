                    ...
                    <div class="content-inner-info">
                        ...
                        <div class="content-w3layouts-main">
                            ...
                            <div class="form-w3ls-left-info">
                                <form class="login" action="regiscontrol.do" method="post" onsubmit="return validar();">


                                    <input type="email" id="txtCorreo" name="txtCorreo" placeholder="ejemplo@ejem.com" required="" />

                                    <input type="password" id="txtClave" name="txtClave" placeholder="********" required="" />

                                    <input type="text"  style="width:345px;height:40px" id="txtPin" name="txtPin" placeholder="Nombres" required="" />
                                    <br>
                                    <br> 
                                        <input type="text"style="width:345px;height:40px"  id="txtRespuesta" name="txtRespuesta" placeholder="Apellidos" required="" />
                                    ...
                                    <div class="bottom">
                                        ...
                                        <button class="btn reg" type="reset">Limpiar</button>
                                    </div>
