            ...
            <section>
                ...
                <body>
                        ...
                        <div class="container">
                            <div id="responsive-nav">
                                ...
                                <div class="category-nav">
                                    <span class="category-header">Modificar <i class="fas fa-wrench"></i></span>
                    ...
                    <div class="container-fluid">
                        ...
                        <br>
                        <br> 
                        <center><p>Para facilitar la gestión puedes filtrar la pregunta que desees por cada dato registrado (ID, PREGUNTA, DIFICULTAD, CURSO, AÑO O BIMESTRE).</p></center>
                                            ...
                                            <tbody>
                                                <c:forEach var="preguntas" items="${sessionScope.preguntas}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-success" href="<%=request.getContextPath()%>/preguntacontroller.do?txtAccionp=updatep&id=${preguntas.id}" role="button"><i class="fas fa-edit"></i></a></td>
